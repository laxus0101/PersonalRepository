<template>
  <div class="flex flex-col min-h-screen isolate bg-cyan-100 dark:bg-gray-800">
    <header class="flex justify-end content-center pe-14 py-1 sticky top-0 bg-cyan-200 dark:bg-gray-700 z-10">
